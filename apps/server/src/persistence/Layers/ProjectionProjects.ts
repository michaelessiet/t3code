...
import { ModelSelection, ProjectScript, WorkspaceRootRef } from "@t3tools/contracts";
    ...
    execute: (row) =>
      sql`
        ...
        VALUES (
          ...
          ${row.title},
          ${row.workspaceRoot},
          ${JSON.stringify(row.additionalRoots)},
        ...
        DO UPDATE SET
          ...
          additional_roots_json = excluded.additional_roots_json,
