...
export const CHAT_INLINE_THREAD_CHIP_CLASS_NAME =
  "inline-flex max-w-full items-center gap-1 rounded-md border border-sky-500/25 bg-sky-500/12 px-1.5 py-px font-medium text-[12px] leading-[1.1] text-sky-700 align-middle dark:text-sky-300";

export const COMPOSER_INLINE_THREAD_CHIP_CLASS_NAME = `${CHAT_INLINE_THREAD_CHIP_CLASS_NAME} select-none`;

export const THREAD_CHIP_ICON_SVG = `<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.85" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>`;
