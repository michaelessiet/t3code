...
export const SET_CODE_EDITOR_FOCUS_CHANNEL = "desktop:set-code-editor-focus";
...
export const LOCAL_ENVIRONMENT_BOOTSTRAPS_CHANGED_CHANNEL =
  "desktop:local-environment-bootstraps-changed";
