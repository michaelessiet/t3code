...
**Snapshot: 51 present · 39 partial · 99 absent.** M1 (chat core) and M2 slices 1–5
...
master plan schedules as M3+ (preview, settings, source control,
...
grid renderer, lifecycle, input arbitration, tabs/groups, theme) landed 2026-09-03.
