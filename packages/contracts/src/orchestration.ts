...
// Non-image attachments (source files, PDFs, text documents, ...). Any MIME
// type is accepted at the contract layer; provider adapters decide how (or
// whether) each payload can be forwarded to the model.
